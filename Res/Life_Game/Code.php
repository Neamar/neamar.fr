<?php
$Titre='Code de BankNoteStack';
$Box = array("Auteur" => "Neamar","Date" => "Aout 2008","Voir aussi"=>'<a href="../Compiler_AS3">Compiler l\'AS3</a>',"Retour"=>'<a href="../BankNoteStack">Retour au jeu</a>');
include('../header.php');
exit();
?>
<h1>Rapidité et stratégie : BankNoteStack</h1>
