...
<p>Dans la deuxième partie, la règle du jeu change&nbsp;: on ne demande plus de passer une fois sur chaque arête, mais de passer une fois sur chaque n?ud (en empruntant uniquement certaines arêtes, sinon c'est bien entendu évident&nbsp;! ). <br>
...
<p>Cette fois, le point de départ n'a aucune importance&nbsp;: c'est presque aussi incohérent que de demander où commencer à dessiner un cercle&nbsp;! Cependant, intuitivement on préfère commencer sur les n?uds qui ont beaucoup d'arêtes incidentes ? ce qui est idiot, mieux vaut se réserver ces carrefours pour sortir d'une situation bloquée. </p>
...
Et pour complexifier le tout, même l'ajout de propriétés habituellement simplificatrices (par exemple, <a href="https://neamar.fr/Res/BGraphe/">graphe planaire</a>) laisse le problème NP-complet. </p>
...
<li><a href="http://en.wikipedia.org/wiki/File:Lindgren_hypohamiltonian_15.svg">Graphe Hypohamitonien de Lindgren</a>&nbsp;; un graphe hypohamiltonien est un graphe qui n'est pas hamiltonien, mais dont la suppression d'un n?ud (n'importe lequel) le rend hamiltonien. Ici, j'ai supprimé le n?ud en haut du cercle.</li>
<li><a href="http://mathworld.wolfram.com/BlanusaSnarks.html">First Blanusa Snarks</a>&nbsp;: lui aussi est hypohamiltonien, j'ai viré un n?ud.</li>
...
<li>Version RC1 : Futur  (Testeurs : Licoti, Vertigo, Serge, Bom, Lagile, Malphas, Ugo, MyGB, Goulu, Grebnetor, Jolo2, Lagile, Goulu, rastagong)</li>
</ul>
