...
$Box = array("Auteur" => "Neamar","Date" => "Juill. 2008", "Formats" => "<a href=\"La récursivité.pdf\">PDF</a><br /><a href=\"La récursivité.docx\">DOCX</a>", "But" =>"Panorama récursif");
include('../header.php');
?>
...
<p class="centre"><a href="http://neamar.fr/Res/PathFinder">Lien vers le programme complet et fonctionnel (écrit en AS3)<br /><img src="http://neamar.fr/Res/Pathfinder/Images/Pathfinder.png" alt="Décomposition en produit de facteurs premiers" class="nonflottant" /></a></p>
