<?php
$Titre='Un quatrième et dernier jeu de graphe';
...
<p>Jeu en travaux. Suite à des problèmes techniques, la sortie est retardé <em>ad libitum</em> (et je l'espère, pas <em>ad vitam eternam</em>).</p>

<!--
<h2>Le résultat</h2>
<h3>Fichier Flash :</h3>
<div style="border:1px solid black; width:640px; height:480px; margin:auto;">
	<object type="application/x-shockwave-flash" data="Dgraphe.swf" width="640" height="480" >
		<param name="movie" value="Dgraphe.swf" />
...
<p><a href="http://en.wikipedia.org/wiki/Shannon_switching_game" rel="no follow"></a>
